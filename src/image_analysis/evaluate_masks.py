...
def evaluate_binarization_methods(
    mask_adaptive, mask_frangi, mask_morph, mask_ensemble, ground_truth_path
):
    ...
    iou_ensemble, dice_ensemble = calculate_segmentation_metrics(mask_ensemble, gt_mask)

    scores = {
        "Adaptive": iou_adapt,
        "Frangi": iou_fran,
        "Morphological": iou_morph,
        "Ensemble": iou_ensemble,
    }
